...
$username = "root";
$password = "";
$databaseName = "Dublin_Core_Metadata_Specification";
...
//This section gives the user the option to update the database with a new record
...
//This section allows a user to delete a specific row based on a row number input
echo '<br>';
...
//This section allows a user to update a specific row
echo '<br>';
