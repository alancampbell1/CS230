...
//TODO: Generate random number between 0 and 10 that can access random questions from the quiz
$_SESSION['randomNumber'] = mt_rand(0, 1);

echo 'The current user is ' . $_SESSION["OverallUser"]; echo '<br>';
echo "Your current top score is " . $_SESSION['userScore']; echo '<br>';
echo "Your current score is " . $_SESSION['score']; echo '<br>';

echo "A random number is " . $_SESSION['randomNumber'];
...
echo $_SESSION['questionsAnswered'];
